    ...
    resources: [
      {
        ...
        description:
          "Unsplash has its own license, which essentially lets you use the images for free, in any way you like (except for using them to create a competing website). The site is powered by a community of almost 300,000 photographers,",
        keywords: ["free photos", "free pictures", "frontend"],
      },
      {
        id: 2,
        name: "Pexels",
        ...
        description:
          "Same like Unsplash Photographers provide the photos themselves.Pexels also has its own license, which states what you can and cannot do with the images. You can use and modify the images for free for both commercial and personal use without attribution.",
        keywords: ["free photos", "free pictures", "frontend"],
      },
      {
        id: 3,
    ...
    resources: [
      {
        ...
        description:
          "Copyright Free icons to use on your website or project until you don't have your own",
      },
      {
        id: 22,
        name: "React-icons",
